...
<head>
    ...
    <title>Paket Haji | SISKOHAT</title>
...
<body>
    ...
    <section class="hero hero-berita center" style="background:linear-gradient(135deg, #1a472a, #2d7a3a); padding:60px 0;">
        <div class="container">
            <h1 style="color:#fff; font-size:36px;">Paket Haji</h1>
            <p style="color:#c9e2c9;">Pilihan layanan resmi penyelenggaraan ibadah haji</p>
        </div>
    </section>
    ...
    <section class="section" style="padding:40px 0;">
        <div class="container">
            <div class="paket-grid">
                ...
                @empty
                    <p style="grid-column:1/-1; text-align:center; color:#999;">Belum ada paket haji. Silakan tambahkan melalui admin.</p>
                @endforelse
            </div>
        </div>
    </section>
